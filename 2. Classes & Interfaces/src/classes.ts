...
const dept: Departments = new Departments("Spurgeon House");
console.log(dept);
...
const dept1: DepartmentsOne = new DepartmentsOne("Spurgeon House", [
  "Gnan",
  "Prakash",
]);
console.log(dept1);
...
const dept2: DepartmentsTwo = new DepartmentsTwo("Spurgeon House", [
  "shalem",
  "raj",
]);
console.log(dept2);
